  ...
  async execute(interaction) {
    try {
      ...
      if (response.ok) {
        ...
        const img_id = img_url
          .split("https://cdn.purrbot.site/sfw/angry/gif/angry_")[1]
          .split(".gif")[0];
        ...
        await interaction.reply(
          "Sorry, I couldn't fetch any yaoi image right now. Try again later!",
        );
      }
    } catch (error) {
      console.error("Error in yaoi command:", error);
      await interaction.reply(
        "Oops! Something went wrong while getting your yaoi image.",
      );
    }
  },
};
