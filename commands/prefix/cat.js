    ...
    async execute(message, args) {
        try {
            ...
            if (response.ok) {
                ...
                await message.reply("Sorry, I couldn't fetch a cat image right now. Try again later! 😿");
            }
        } catch (error) {
            console.error('Error in cat command:', error);
            await message.reply("Oops! Something went wrong while getting your cat image. 😿");
        }
    },
};
